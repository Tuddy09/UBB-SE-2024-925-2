namespace TwoPlayerGames.Domain.Auxiliary
{
    ...
    {
        private Player2PlayerGame _player;
        private int _trophies;
        private int _averageElo;
        private string _rank;
        private Games? _favoriteGame;

        public Player2PlayerGame Player { get => _player; set => _player = value; }
        ...
        public PlayerStats(Player2PlayerGame player, int trophies, int averageElo, string rank, Games favoriteGame)
        {
            this._player = player;
        ...
        public PlayerStats(Player2PlayerGame player)
        {
            this._player = player;
            this._trophies = 0;
            this._averageElo = 0;
