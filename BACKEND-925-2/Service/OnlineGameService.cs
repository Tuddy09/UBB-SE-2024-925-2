...
namespace BACKEND_925_2.Service
{
    public class OnlineGameService : IPlayService
    {
        ...
        private Player2PlayerGame opponentPlayer;
        ...
        public OnlineGameService(string gameType, Player2PlayerGame player, GamesDbContext gameDbContext, params object[] optional_params)
        {
            this.player = player;
            ...
            Player2PlayerGame opponentPlayer;
        ...
        private void SendPlayer(Player2PlayerGame player)
        {
        ...
        private Player2PlayerGame ReceivePlayer()
        {
            byte[] buffer = new byte[1024];
            int bytesRead = socket.Receive(buffer);
