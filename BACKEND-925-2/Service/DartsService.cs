...
namespace BACKEND_925_2.Service
{
    public class DartsService : IGameService
    {
        ...
        private readonly List<Player2PlayerGame> playersId;

        public DartsService(Guid gameStateId, Player2PlayerGame player1, Player2PlayerGame player2, IGameRepo repo)
        {
        ...
        public int CalculateThrowScore(int xTarget, int yTarget, Player2PlayerGame player)
        {
        ...
        public IGame Play(int nrParameters, object[] parameters)
        {
            ...
            {
                dartsGame.GameState.Winner = player;
            }
