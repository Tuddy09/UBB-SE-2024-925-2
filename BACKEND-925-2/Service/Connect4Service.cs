...
namespace BACKEND_925_2.Service
{
    public class Connect4Service : IGameService
    {
        ...
        private readonly List<Player2PlayerGame> players;
        private IGameRepo connect4Repo;

        public Connect4Service(Guid gameStateID, Player2PlayerGame player1, Player2PlayerGame player2, IGameRepo repo)
        {
            connect4Repo = repo;
            ...
            {
                connect4Game = new Connect4Game(player1, player2);
                if (player2.Name != "Bot")
                {
            ...
            {
                connect4Game = (Connect4Game?)connect4Repo.GetGameById(gameStateID);
            }
        }
        ...
        public IPiece DropPiece(int column, Player2PlayerGame player)
        {
            Connect4Board board = (Connect4Board)connect4Game.Board;
            if (CheckValidity(column) == false)
            {
        ...
        {
            connect4Game = (Connect4Game)game;
        }
    }
}
