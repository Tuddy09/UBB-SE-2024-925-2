...
namespace BACKEND_925_2.Service
{
    public class ChessService : IGameService
    {
        ...
        public ChessService(Guid gameStateID, Player2PlayerGame player1, Player2PlayerGame player2, ChessModes mode, int startPlayer, IGameRepo repo)
        {
            chessRepo = repo;
        ...
        private bool ExecuteMoveIfValid(int initialX, int initialY, int newX, int newY, Player2PlayerGame player)
        {
        ...
        private bool IsInCheck(int kingX, int kingY, Player2PlayerGame player)
        {
        ...
        private bool HasValidMovesLeft(int kingX, int kingY, Player2PlayerGame kingColor)
        {
        ...
        private bool HasOtherPieces(Player2PlayerGame player)
        {
        ...
        {
            Player2PlayerGame currentPlayer = GetCurrentPlayer();
